...
In the result is shown in Figure \ref{fig:slowdownWithSize.png}, we observed that when the library is small enough to fit in the cache, not much slowdown is observed.
